export const updates = [
  {
    id: 1,
    slug: "iccr-2026-application-open",
  ...
  {
    id: 2,
    slug: "study-in-india-admissions-open",
  ...
  {
    id: 3,
    slug: "iccr-deadline-reminder-2026",
  ...
  },
  {
    ...
    title: "COMPEX 2026–27: Updated Email ID for Technical Issues 📢",
    content:
      "Important Notice for all COMPEX 2026–27 candidates!\n\nDue to a technical issue with the previously shared email ID, candidates are requested to send their technical queries/issues related to COMPEX 2026–27 to the new email ID:\n\n📧 examgrievance@edcil.co.in\n\nCandidates who have already sent their technical issues on or after 07.09.2026 are also requested to resend their emails to the new email ID.\n\nCandidates are requested to use the new email ID for all technical issues related to COMPEX 2026–27 with immediate effect.",
    type: "announcement",
    tags: ["COMPEX", "Scholarship", "Technical Issues", "Email Update"],
    source: "COMPEX 2026–27",
    isPinned: true,
